...
state = phy.new_state([phy.new_object(1, 1, phy.new_vector(0, 0, 0), np.identity(3), phy.new_vector(0, 0, 0), phy.new_vector(0, 0, 0), 0.47, phy.local_force_model, phy.global_force_model)])
